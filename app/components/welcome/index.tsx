  ...
  return (
    <div className='relative mobile:min-h-[48px] tablet:min-h-[64px]'>
      ...
      <div className='mx-auto pc:w-[794px] max-w-full mobile:w-full px-3.5'>
        ...
        {/* foot */}
        {!hasSetInputs && (
          <div className='m-4 flex justify-between items-center h-10 text-xs text-gray-400'>
            ...
            <a className='flex items-center pr-3 space-y-3 space-x-3' href="https://mentor-ai-nu.vercel.app/" target="_blank">
